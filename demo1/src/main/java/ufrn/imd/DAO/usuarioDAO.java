...
public class usuarioDAO {
    ...
    public void lerArquivoUsuario() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(SRC_USUARIOS))) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                for (Directory direcAux : diretoriosDAO.getBd_diretorios()) {
                    System.out.println(direcAux.getCaminho() + " - " + usuario.getNome());
                    String caminho = "demo1\\src\\main\\diretorios\\" + usuario.getNome() + "Diretorio";
    ...
    private Usuario criarUsuario(String[] dadosUsuario) {
        Usuario usuario;
        boolean isVip;
        isVip = dadosUsuario[5].equals("UsuarioVip");
    ...
    public static void atualizarArquivo(List<Usuario> usuarios) {
